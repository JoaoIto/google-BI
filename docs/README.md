# Detalhamento de Planejamento de BI - Google Fiber

Este documento descreve detalhadamente cada etapa de planejamento do projeto de Business Intelligence para o cenário do Google Fiber, referenciando as imagens das etapas documentadas e os documentos originais do curso.

## Documentos e Modelos Utilizados

Na pasta `docs/`, foram renomeados os arquivos originais base do curso para garantir melhor didática. Incluem os modelos de **Documento de Estratégia**, **Requisitos das Partes Interessadas** e **Requisitos do Projeto** (tanto de um projeto auxiliar de exemplo "MarkIt" quanto os templates do "Google Fiber").

## As Etapas do Curso (Visualizadas)

O curso e a dinâmica da "entrevista simulada" foram divididos em etapas claras:

### Resumo do Que Incluir no Projeto
Nesta etapa, o curso define que o projeto concluído deva obrigatoriamente incluir versões preenchidas do Documento de Requisitos das Partes Interessadas, Documento de Requisitos do Projeto, Documento de Estratégia e três perguntas fundamentais para a equipe.
![O Que Incluir](./01_Etapa_O_Que_Incluir.png)

### Etapa 1: Abrir as Anotações
Aqui inicia-se a compilação do contexto da entrevista "fictícia" com Emma Santiago, Keith Portone e Minna Rah, traduzindo o desejo da redução em chamadas do Google Fiber em ação de BI.
![Etapa 1](./02_Etapa_1_Abra_Anotacoes.png)

### Etapa 2: Acessar os Modelos
Nesta etapa baixamos e renomeamos os arquivos base do curso que balizam toda a formulação dos dados abaixo. 
![Etapa 2](./03_Etapa_2_Acesse_Modelos.png)

### Etapa 3: Preenchimento (Requisitos das Partes Interessadas)
A consolidação das necessidades de quem são os stakeholders e como a ferramenta será utilizada no dia a dia.
![Etapa 3](./04_Etapa_3_Preencher_Requisitos.png)

*(Existem também as imagens complementares das etapas 4 em diante arquivadas sequencialmente em `./05_Etapa_Extra_1.png` até a `08_...` caso seja necessário consulta de fluxos adicionais do curso).*

---

## O Planejamento Consolidado

Abaixo está o conteúdo formal e planejado com base nas transcrições do cenário e necessidades da equipe:
...
As perguntas abaixo foram redigidas para identificar lacunas nos dados que impactariam diretamente na execução do projeto:
