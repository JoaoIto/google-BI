...
## 🛠️ Atividade Prática: BigQuery Sandbox
...
### 2. Consultando Dados Públicos
Para praticar, você pode usar conjuntos de dados públicos disponíveis no próprio BigQuery.

**Consulta de Exemplo (Bike Share):**
